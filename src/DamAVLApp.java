...
import java.io.*;
    ...
    /**This application loads information from a parameterised file into an AVL Tree, creating a database of dams which,
      *when ran with no arguments, prints out all the dams stored in then AVL Tree. The user has to use a console in order
...
public class DamAVLApp{
    ...
    /**This method uses a parameterized file, and parses the text that is stored in the file to create an AVL Tree that
      ...
      *file and then stores these values into an oject, adds them to an AVL Tree and returns the createdn AVL Tree.*/
      
    public static AVLTree<Dam> readText(BufferedReader input){
        try{
            String line = "";
            AVLTree<Dam> dams = new AVLTree();
    ...
    return dams;
        ...
        System.exit(0);
        return new AVLTree<Dam>();
        }
    }
    
    /**This method uses the readText method to create an AVL Tree from a file that stores data on different dams and uses
    ...
    public static void printDam(String damName){
        ...
        try{
            ...
            AVLTree<Dam> dams = readText(input);
            int opcount = 0;
            ...
            if(Find == null)
                ...
                String u = "Output of Search Instrumentation of DamAVLApp: " + dams.SearchopCount + "\n";
                file2.write(u);
                file2.close();
            ...
            try{
                File file = new File("outputfileAVL.txt");
                FileWriter outputfile = new FileWriter("outputfileAVL.txt");
    ...
    public static void printDam(String damName, String FileName){
        try{
            ...
            if(Find == null)
                ...
                String u = "Output of Search Instrumentation of DamAVLApp: " + opcount + "\n";
                file2.write(u);
                file2.close();
    ...
    /**This method inserts a new dam object into an AVL Tree that is constructed within the method. It then writes the results of the
    ...
    public static void insertDam(String damdets){
        try{
            ...
            int sropcount = 0;
            dams.insert(dam);
            inopcount = dams.InsertopCount;
            BinaryTreeNode<Dam> Find = dams.find(dam);
            sropcount = dams.SearchopCount;
            if(Find == null)
                System.out.println("Insert was not successful. The program will now exit.");
            else{
                System.out.println(Find.data);
                String u = "Output of Insert Instrumentation of DamAVLApp: " + inopcount + "\n";
                String v = "Output of Search Instrumentation of DamAVLApp after Insert: " + sropcount + "\n";
                file2.write(u + v);
                file2.close();
    ...
    /**This method makes use of the readText method to create an AVL Tree from a file that stores data on different dams and
